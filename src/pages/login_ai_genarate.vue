    ...
    <main class="flex-grow flex items-center justify-center w-full max-w-md z-10">
      <div class="bg-white bg-opacity-80 backdrop-blur-lg rounded-2xl shadow-xl p-8 w-full border border-gray-200">
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            class="!rounded-button whitespace-nowrap w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            立即登录
          </button>
        </form>
